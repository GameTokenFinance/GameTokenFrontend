...
const ActionPanel: React.FunctionComponent<ActionPanelProps> = ({ details, apr, multiplier, liquidity, deposit }) => {
  const farm = details
  ...
  const info = `https://info.apeswap.finance/pairs/${lpAddress}`
  ...
  return (
    <Container>
      <InfoContainer>
        {isActive && (
          <StakeContainer>
            <StyledLinkExternal href={`https://dex.apeswap.finance/#/add/${liquidityUrlPathParts}`}>
